...
AdSense 審査中は、操作画面に広告枠を出さず、トップページなど公開コンテンツとして読めるページに限定します。
...
AdSense 審査中は、登録、編集、読み取り、ログイン、設定、カテゴリ、空の一覧や集計など、ユーザー操作が主目的の画面には広告枠を出しません。

広告枠は、トップページや使い方・サービス説明など、公開された読み物として成立するページに限定します。
広告未配信時に大きな空白が残らないよう、既存の非表示処理を維持します。
